...
ALTER TABLE swaps ALTER COLUMN token_amount TYPE NUMERIC(39,0);
ALTER TABLE swaps ALTER COLUMN zil_amount TYPE NUMERIC(39,0);
ALTER TABLE liquidity_changes ALTER COLUMN change_amount TYPE NUMERIC(39,0);
ALTER TABLE liquidity_changes ALTER COLUMN token_amount TYPE NUMERIC(39,0);
ALTER TABLE liquidity_changes ALTER COLUMN zil_amount TYPE NUMERIC(39,0);
ALTER TABLE distributions ALTER COLUMN amount TYPE NUMERIC(39,0);
ALTER TABLE claims ALTER COLUMN amount TYPE NUMERIC(39,0);
